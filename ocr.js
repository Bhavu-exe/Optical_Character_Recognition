var ocrDemo = {
    ...
    BLUE: '#0000FF', // Assuming BLUE is a color value
    data: new Array(400).fill(0), // Assuming data is an array of zeros
    trainArray: [],
    trainingRequestCount: 0,
    BATCH_SIZE: 10, // Assuming a batch size for training
    HOST: 'http://localhost', // Assuming a host value
    PORT: '8080', // Assuming a port value
